/datum/job/roguetown/vicar
	...
	total_positions = 1
	spawn_positions = 1
	outfit = /datum/outfit/job/roguetown/vicar
	display_order = JDO_VICAR
...
/datum/outfit/job/roguetown/vicar/pre_equip(mob/living/carbon/human/H)
    ..()
